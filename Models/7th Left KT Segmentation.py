# -*- coding: utf-8 -*-
"""Left_KT_Segmentation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/17wkoWZPxy4IgCA2ZcT9I2CAthkqnHpAS
"""
...
patient_info = patient_info[patient_info['Patient_Num'] != 1]
patient_info = patient_info[patient_info['Patient_Num'] != 57]

patient_info.info()

patient_info.sample(5)

flg = patient_info['Segmentation_Left_Label'].value_counts()
display(flg)
fig = plt.figure(figsize =(15, 30))
plt.pie( flg , labels=flg.index , autopct='%1.1f%%', shadow=True, startangle=90 )
plt.title('Segmentation Left Label')
plt.show()
...
patient_info['Segmentation_Left_Label'].value_counts()

labels = { 0:"Upper", 1:"Lower" , 2:"Middle" , 3:"Healthy" }

patient_info = patient_info [patient_info['Segmentation_Left_Label'] != 4 ]
...
X , y  = get_data("sample_data/Dalia_Data/", target = "Segmentation_Left_Label")
...
history = model.fit(
                training_set,
                steps_per_epoch = (2842 /128),
                epochs=100, 
                validation_data=test_set,
                validation_steps = (1096 /128)
                )
...
labels = { 0:"Healthy", 1:"Lower" , 2:"Middle" , 3:"Upper" }
...
target_names = ['Healthy',"Lower",'Middle',"Upper"]
